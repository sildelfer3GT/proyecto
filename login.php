...
if($_POST){
    ...
    try {
        $sentencia = $conexion->prepare("SELECT * FROM usuarios WHERE email=:email AND contra=:contra");
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-none d-lg-block willpower"></div>
                            <div class="col-lg-6">
                                <div class="p-5 mb-5">
                                    ...
                                    <form class="user" action="" enctype="multipart/form-data" method="post">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" id="email" name="email" aria-describedby="emailHelp" placeholder="Correo">
                                        </div>
                                        <div class="form-group">
